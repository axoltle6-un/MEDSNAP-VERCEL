    ...
    return [
      {
        ...
        headers: [
          ...
          // Content-Security-Policy — restrict resource loading while allowing Tesseract OCR blob workers, Firebase Auth & Stripe
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://www.gstatic.com https://www.googleapis.com https://apis.google.com https://js.stripe.com",
              ...
              "connect-src 'self' https://api.fda.gov https://rxnav.nlm.nih.gov https://dailymed.nlm.nih.gov https://api.mistral.ai https://api.llm7.io https://api.openrouter.ai https://upload.wikimedia.org https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://firestore.googleapis.com https://*.firebaseapp.com https://*.firebaseio.com wss://*.firebaseio.com https://*.googleapis.com https://pubchem.ncbi.nlm.nih.gov https://api.stripe.com",
